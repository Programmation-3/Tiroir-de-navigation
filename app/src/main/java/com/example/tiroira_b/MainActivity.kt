...
import com.example.tiroira_b.databinding.ActivityMainBinding
import com.example.tiroira_b.databinding.NavHeaderBinding
        ...
        binding.nvTiroir.setNavigationItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.deconnexion_item -> {
                    Log.v("Déconnexion","Déconnexion réussie!")
                }
            }
            false
        }
